...
while loopBreaker != 'stop' and BitcoinHelper.getCapitalLeft() > 0:
    ...
    for price in prevPriceJSON["boughtPrices"]:
        if possibleBuy >= price * 1.001:
            ...
            print("0.0001 Bitcoin was sold at: " + str(possibleBuy), flush=True)
